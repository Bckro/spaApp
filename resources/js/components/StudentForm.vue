<template>
    <form @submit.prevent="submit">
        ...
        <div>
            <input type="text" v-model="$v.form.index.$model" placeholder="Numer indeksu" />
        ...
        <button type="submit">{{ student ? 'Aktualizuj' : 'Dodaj' }}</button>
    </form>
</template>
...
export default {
    ...
    validations: {
        form: {
            ...
            age: { required, integer, between: between(18, 26) }
        }
    },
    methods: {
        submit() {
